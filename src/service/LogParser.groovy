...
class LogParser {
    ...
    List<SearchLog> oldSearchLogs   // Parsed data from old formatted logs
    List<SearchLog> searchLogs      // Parsed data from new formatted search logs
    List<RequestLog> requestLogs    // Parsed data from new formatted request logs
    ...
    private void parseNewLogLine(String[] line){
        ...
        if (log.containsKey("id")){
            RequestLog requestLog = new RequestLog(date, type, log.id)
    ...
    private void parseOldLogLine(String[] line) {
        ...
        SearchLog searchLog = new SearchLog(date, type, tQuery, tFilters, tFacet, tPage)
        this.oldSearchLogs.add(searchLog)
    }
